...
export function ChatInput({ isLoading, onSubmit, input, setInput, disabled, placeholder, onStop, showStopButton }: ChatInputProps) {
    ...
    return (
        <div className="relative mx-auto w-full max-w-3xl p-4">
            <div className={`relative flex flex-col rounded-3xl border border-white/10 bg-neutral-900/50 shadow-2xl backdrop-blur-xl transition-all focus-within:border-white/20 focus-within:bg-neutral-900/80 ${disabled ? 'opacity-50 pointer-events-none' : ''}`}>
                {/* Input Area */}
