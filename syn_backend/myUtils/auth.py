...
async def _check_cookie_impl(type, file_path):
    ...
    """
    match type:
        case 1: return await cookie_auth_xhs(Path(BASE_DIR / "cookiesFile" / file_path))
        case 2: return await cookie_auth_tencent(Path(BASE_DIR / "cookiesFile" / file_path))
        case 3: return await cookie_auth_douyin(Path(BASE_DIR / "cookiesFile" / file_path))
        case 4: return await cookie_auth_ks(Path(BASE_DIR / "cookiesFile" / file_path))
        case 5: return await cookie_auth_bilibili(Path(BASE_DIR / "cookiesFile" / file_path))
