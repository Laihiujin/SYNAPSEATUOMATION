...
def get_chart_data(db_path: Path, start_date: Optional[str] = None, end_date: Optional[str] = None, days: int = 7) -> List[Dict]:
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        return [{"date": row[0], "playCount": row[1]} for row in rows]
