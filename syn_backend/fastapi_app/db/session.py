...
# 创建全局连接池实例
main_db_pool = ConnectionPool(settings.DATABASE_PATH, pool_size=5)
cookie_db_pool = ConnectionPool(settings.COOKIE_DB_PATH, pool_size=5)
ai_logs_db_pool = ConnectionPool(settings.AI_LOGS_DB_PATH, pool_size=3)
